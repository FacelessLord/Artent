...
public class SprayParticleEntityModel extends EntityModel<SprayElementEntity> {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        modelPartData.addChild("fire",
                               ModelPartBuilder.create().uv(0, 0).cuboid(-1F, -1F, -1F, 2, 2, 2),
                               ModelTransform.NONE);
        modelPartData.addChild("water",
                               ModelPartBuilder.create().uv(0, 8).cuboid(-1F, -1F, -1F, 2, 2, 2),
                               ModelTransform.NONE);
