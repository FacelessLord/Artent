...
public class VoidBlockRenderer implements BlockEntityRenderer<VoidBlockEntity> {
	...
	@Override
	public void render(VoidBlockEntity entity, float tickDelta, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int light, int overlay) {
	...
	private void renderSide(VoidBlockEntity entity, Matrix4f model, VertexConsumer vertices, float x1, float x2, float y1, float y2, float z1, float z2, float z3, float z4, Direction side) {
