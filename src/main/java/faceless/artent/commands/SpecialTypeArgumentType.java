...
public class SpecialTypeArgumentType
  implements ArgumentType<SpecialMobType> {
    ...
    private static final DynamicCommandExceptionType INVALID_SPECIAL_MOB_TYPE_EXCEPTION = new DynamicCommandExceptionType(
      specialMobType -> Text.stringifiedTranslatable("artent.argument.specialMobType.invalid", specialMobType));
    ...
    public static SpecialMobType getSpecialMobType(
