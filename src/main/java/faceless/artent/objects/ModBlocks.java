...
public final class ModBlocks {
	...
	public static ArtentBlock DungeonSandstone = new ArtentBlock("sandstone_dungeon_block", FabricBlockSettings.copyOf(Blocks.SANDSTONE)
		.sounds(BlockSoundGroup.STONE));
	public static BrewingCauldron BrewingCauldron = new BrewingCauldron(FabricBlockSettings.copyOf(Blocks.CAULDRON).mapColor(MapColor.GRAY)
		.requiresTool()
		.nonOpaque()
	...
	public static BrewingCauldronCopper BrewingCauldronCopper = new BrewingCauldronCopper(FabricBlockSettings.copyOf(Blocks.CAULDRON).mapColor(MapColor.GRAY)
		.requiresTool()
		.nonOpaque()
		.luminance(state -> state.get(faceless.artent.brewing.block.BrewingCauldron.IS_BURNING) ? 15 : 0)
		.strength(2f));
	public static BlockItem BrewingCauldronCopperItem;
	public static Block CauldronFluid = new Block(FabricBlockSettings.copyOf(Blocks.WATER)
		.mapColor(MapColor.GRAY)
		.nonOpaque()
		.dropsNothing());
	...
	public static BerryBush[] berryBush = new BerryBush[]{
		new BerryBush(0, FabricBlockSettings.copyOf(Blocks.ACACIA_LEAVES).mapColor(MapColor.GREEN).nonOpaque().sounds(BlockSoundGroup.GRASS)),
		new BerryBush(1, FabricBlockSettings.copyOf(Blocks.ACACIA_LEAVES).mapColor(MapColor.GREEN).nonOpaque().sounds(BlockSoundGroup.GRASS)),
		new BerryBush(2, FabricBlockSettings.copyOf(Blocks.ACACIA_LEAVES).mapColor(MapColor.GREEN).nonOpaque().sounds(BlockSoundGroup.GRASS)),
		new BerryBush(3, FabricBlockSettings.copyOf(Blocks.ACACIA_LEAVES).mapColor(MapColor.GREEN).nonOpaque().sounds(BlockSoundGroup.GRASS)),
	};
	public static BlockItem[] berryBushItem = new BlockItem[berryBush.length];

	public static PillarBlock CrimsonwoodLog = new PillarBlock(FabricBlockSettings
...
//	public static BlockItem CrimsonwoodSaplingItem = new BlockItem(CrimsonwoodSapling, new FabricItemSettings().group(Core.General));
	public static Block CrimsonwoodPlanks = new Block(FabricBlockSettings
