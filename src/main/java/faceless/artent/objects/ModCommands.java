      ...
      CommandManager.literal("artent").requires(source -> source.hasPermissionLevel(2))
                    .then(CommandManager.literal("setMoney")
                                        .then(CommandManager.argument("player", EntityArgumentType.players())
                                                            .then(CommandManager
                                                                    .argument("money", IntegerArgumentType.integer(0))
                                                                    .executes(ctx -> {
                                                                        var players = EntityArgumentType.getPlayers(ctx,
                                                                                                                    "player");
                                                                        var money = IntegerArgumentType.getInteger(ctx,
                                                                                                                   "money");
                    ...
                    .then(CommandManager.literal("setLevel")
                                        .then(CommandManager.argument("entities", EntityArgumentType.entities())
                                                            .then(CommandManager
                                                                    ...
                                                                    .executes(ctx -> {
                                                                        var entities = EntityArgumentType.getEntities(
                                                                          ctx,
                                                                          "entities");
                                                                        var level = IntegerArgumentType.getInteger(ctx,
                                                                                                                   "level");
                    ...
                    .then(CommandManager.literal("restoreMana")
                                        .then(CommandManager.argument("entities", EntityArgumentType.entities())
                                                            .executes(ctx -> {
                                                                var entities = EntityArgumentType.getEntities(ctx,
                                                                                                              "entities");
                    ...
                    .then(CommandManager.literal("setSpecialType")
                                        .then(CommandManager.argument("entities", EntityArgumentType.entities())
                                                            .then(CommandManager
                                                                    .argument("type",
                                                                              SpecialTypeArgumentType.specialType())
                                                                    .executes(ctx -> {
                                                                        var entities = EntityArgumentType.getEntities(
                                                                          ctx,
                                                                          "entities");
                                                                        var type = SpecialTypeArgumentType.getSpecialMobType(
                                                                          ctx,
                                                                          "type");
