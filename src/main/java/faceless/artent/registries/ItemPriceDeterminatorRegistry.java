...
public class ItemPriceDeterminatorRegistry implements IRegistry {
    ...
    public void register() {
        register(ConstantItemStackPriceDeterminator.NAME,
                 new ConstantItemStackPriceDeterminator(),
                 ConstantItemStackPriceDeterminator.ConstantPriceDeterminatorContext::new);
    }

    public <T extends IPriceDeterminatorContext> void register(
      String registryName,
      IItemStackPriceDeterminator determinator,
      Factory<T> contextFactory
    ) {
