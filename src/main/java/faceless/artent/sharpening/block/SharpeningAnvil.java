...
public class SharpeningAnvil extends BlockWithEntity implements INamed {
	...
	public NamedScreenHandlerFactory createScreenHandlerFactory(BlockState state, World world, BlockPos pos) {
		...
		if (blockEntity instanceof SharpeningAnvilBlockEntity anvil)
			return new SimpleNamedScreenHandlerFactory((syncId, inventory, player) -> new SharpeningAnvilScreenHandler(syncId, inventory, anvil, ScreenHandlerContext.create(world, pos)), Text.translatable("gui.artent.sharpening_anvil"));
		return null;
	}
	...
	public void onStateReplaced(BlockState state, World world, BlockPos pos, BlockState newState, boolean moved) {
		if (state.getBlock() != newState.getBlock()) {
			...
			if (blockEntity instanceof SharpeningAnvilBlockEntity) {
				ItemScatterer.spawn(world, pos, (SharpeningAnvilBlockEntity) blockEntity);
				// update comparators
