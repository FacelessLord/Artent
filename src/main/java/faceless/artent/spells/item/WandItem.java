...
public class WandItem extends ArtentItem implements ISharpenable {
    ...
    protected Hand getOppositeHand(Hand hand) {
        return switch (hand) {
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity player, Hand hand) {
        ...
        var spell = getSelectedSpell(player, hand);
        if (spell == null)
    ...
    private Spell getSelectedSpell(PlayerEntity player, Hand hand) {
    ...
    @Nullable
    private Spell getActiveEntitySpell(LivingEntity user) {
