...
public class Transmutation {
    ...
    public boolean randomPoints(
      World world, int count, BlockPos center, Direction facing, int widthRange, int heightRange,
    ...
    public boolean randomPoint(
      World world, BlockPos center, Direction facing, int widthRange, int heightRange,
